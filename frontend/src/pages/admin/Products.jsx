  ...
  <img
    src={
      typeof product.images?.[0] === "string"
        ? product.images[0]                                         // direct string URL
        : product.images?.[0]?.url || product.images?.[0]?.path ||  // object-url/path
          "https://via.placeholder.com/48"
    }
    alt={product.name}
    className="w-full h-full object-cover"
    onError={(e) => {
      e.currentTarget.src = "https://via.placeholder.com/48";       // fallback on broken link
    }}
  />
</div>
